...
export class VerificationService {
  ...
  save(
    emailVerificationService: Partial<EmailVerification>,
  ...
  async prepareVerificationSchemaBeforeSending(userId: number) {
    ...
    return await this.emailVerificationRepository.save(
      this.emailVerificationRepository.create(emailVerificationSchema),
    );
  }
